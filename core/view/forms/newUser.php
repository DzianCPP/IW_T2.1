...
<?php echo "Hello"; ?>
    ...
    <form class="new-user-form" method="POST" action="/user/create">
       ...
       <div><input type="text" class="input-text" name="email" id="email" placeholder="Enter your email" onchange="formValid()"></div>

        <div><label class="form-label" for="name">Your first and last name</label></div>

        <div><input type="text" class="input-text" name="name" id="name"
            placeholder="Enter your first and last name" onchange="formValid()"></div>
