...
define('USER_CONTROLLER_PATH', BASE_PATH . 'core/controllers/UserController.php');
define('CONTROLLERS_PATH', BASE_PATH . 'core/controllers/');
define('AUTOLOAD_PATH', BASE_PATH . 'system/autoload.php');
define('IMAGES_PATH', BASE_PATH . 'public/assets/images/');
